...
.batch-daily-tasks [style*="background-color: #f8f9fa"],
.batch-daily-tasks [style*="background-color:#f8f9fa"] {
...
.batch-daily-tasks [style*="background: #f7f8fa"],
.batch-daily-tasks [style*="background:#f7f8fa"] {
  background: var(--app-surface-muted) !important;
  border-color: var(--app-line) !important;
}

.batch-daily-tasks [style*="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%)"] {
  background:
    linear-gradient(135deg, rgba(var(--primary-color-rgb), 0.92), rgba(20, 184, 166, 0.86)) !important;
}

.batch-daily-tasks [style*="border: 1px solid #e9ecef"] {
  border-color: var(--app-line) !important;
}
...
.batch-daily-tasks [style*="color: #667eea"],
.batch-daily-tasks [style*="color:#667eea"] {
