...
export default {
  async fetch(request, env, ctx) {
    ...
    if (proxy) {
      ...
      // Prepare request headers. Do not forward hop-by-hop or origin Host
      // headers from the static site; let fetch set the target host itself.
